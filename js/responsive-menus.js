...
( function( document, $, undefined ) {
  ...
  var genesisMenusUnchecked = genesisMenuParams.menuClasses;
  var genesisMenus = {};
  var menusToCombine = [];
  ...
  var responsiveMenuClass = 'genesis-responsive-menu';
  ...
  function _combineMenus( buttons ) {
    ...
    var combinedMenus = $( menusToCombine ).filter( function( index ) {
      if ( 0 < index ) {
        return index;
      }
    });
  ...
  function _changeSkipLink( buttons ) {
    ...
    $.each( menuToggleList, function( key, value ) {
      ...
      var endLink = 'genesis-mobile-' + newValue;
